    ...
    def exportC3UsingRef(outputPath, refPath):
        ...
        while True:
            ...
            if meshName in PHY_section_names:
                ...
                #fileWriter.writeInt(sectSize) ######
                fileWriter.writeInt(nsize)
                fileWriter.writeString(meshName)
                offset = 4 + nsize
                #fileWriter.writeBinaryString(file.data[sectionStart+offset:sectionStart+offset+4])########
                ...
                for a in range(vertCount):
                    ...
                    #fileWriter.fillZeros(0x14)
                    #fileWriter.writeBinaryString(file.data[sectionStart+offset:sectionStart+offset+0x14])
                    #fileWriter.writeInt(0)
                    #fileWriter.writeInt(7)
                    #fileWriter.writeInt(0)
                    #fileWriter.writeBinaryString(file.data[sectionStart+offset+12:sectionStart+offset+8+12])
                    #fileWriter.writeFloat(1.0)
                    #fileWriter.writeFloat(0.0)
